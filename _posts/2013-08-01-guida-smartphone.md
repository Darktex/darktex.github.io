...
1. __Vodafone Smart Mini__

    _Mediatek 1 GHz single core, 512 MB RAM, 3.5' 480x320, 59€_

    ![mini](http://www.digita.org/wp-content/uploads/2013/06/Vodafone-Smart-Mini_2.jpg)


    + PRO: Il prezzo. Potete portarlo in giro senza paura che ve lo rubino, e se accade... Beh potete sopravvivere :P Inoltre ha Jelly Bean (requisito che considero essenziale per acquistare un telefono Android nel 2013).
         
    + CONTRO: Lento, touchscreen molto peggio che mediocre. Schermo molto piccolo e con una risoluzione veramente molto bassa.
...
1. __Huawei Y300__
    ...
    _SnapDragon 1 GHz dual core, 512 MB RAM, 4' 800x480, 4 GB ROM espandibile microSD, 130€_

    ![y300](http://www.tecnologici.net/wp-content/uploads/2012/10/y-300.jpg)


    + PRO: Dual core. Jelly Bean. Prezzo. Batteria.
         
    + CONTRO: Qualità costruttiva mediocre. Solo 1 GB di spazio per le app
         
    + COMMENTO: Per questo telefono valgono commenti simili a quelli fatti per il Vodafone Smart Mini: non ne ho un'esperienza diretta, ma lo consiglio comunque perché vince per abbandono. A 130€ non esiste __niente__ nel mondo Android che possa rivaleggiarvi. Purtroppo i 512 MB di RAM sono veramente pochi per far girare l'esoso Android senza lag, ma la CPU non solo è dual core ma è anche uno SnapDragon cosa che lo rende più veloce di un Mediatek o di un Novathor (ne parlerò in un futuro blog post magari).

1. __Huawei W1__

    _SnapDragon 1.2 GHz dual core, 512 MB RAM, 4' 800x480, 4 GB ROM espandibile microSD, 130€_

    ![w1](http://photos.expertreviews.co.uk/images/front_picture_library_Expert_Reviews/dir_385/er_photo_192904_42.jpg)


    + PRO: Dual core. Windows 8. Prezzo. Batteria.
         
    + CONTRO: Qualità costruttiva mediocre.
         
    + COMMENTO: Questo è secondo me il vero campione della fascia bassa. È sostanzialmente un Y300 riadattato per Windows Phone 8, e mostra come WP8 sia __molto__ meno esoso di Android in termini di RAM. Questo telefono è l'unico a non laggare in questa fascia, e lo consiglio a tutti coloro a cui non serve necessariamente Android (cioè quasi tutti, esclusi forse gli aspiranti dev per Android a cui consiglio di comprare l'Y300). WP8 non vi fornirà la stessa quantità di apps di Android o iOS, ma tutte quelle principali ci sono e in fascia alta io preferisco rinunciare a feature piuttosto che prestazioni - in altri termini, meglio fare meno cose ma bene che farne tante ma male.
...
1. __LG/Google Nexus 4__
    ...
    + PRO: Tutto. Un telefono da 700€ a meno della metà del suo prezzo.
         
    + CONTRO: Scalda un po' troppo, non è più __il__ top di gamma, vicino ad essere dismesso (quello nuovo uscirà a Novembre).
...
1. __Motorola Razr Maxx HD__

    _SnapDragon S4 Pro 1.5 GHz quad core, 1 GB RAM, 4.7' 1280x720, 16/32 GB ROM espandibili microSD, prezzo variabile (va importato dagli USA)_

    ![Razr Maxx HD](http://i-cdn.phonearena.com/images/phones/37947-xlarge/Motorola-DROID-RAZR-MAXX-HD.jpg)
         
    + PRO: Batteria GIGANTESCA, il doppio di uno smartphone normale. Materiali nobilissimi, dal kevlar del retro al nanocoating contro l’acqua. Jelly Bean. Bello esteticamente, potente.
         
    + CONTRO: Bootloader bloccato.
         
    + COMMENTO: Se avete bisogno di batteria, questo è il meglio possibile. Ora è un po’ vecchiotto (generazione S3) ma non si può certo dire che sia lento o datato (ha la 4.1). Niente ROM custom per voi, questo è il difetto maggiore.

   + NOTA: __OCCHIO ALLE FREQUENZE!__ Non dovreste avere problemi ma prima di comprare un telefono americano vi consiglio __molto__ caldamente di leggervi [la mia guida alle frequenze](/blog/smartphone-e-frequenze/) in modo da fare un acquisto con cognizione di causa.

### TASTIERA FISICA 

1. __Motorola Photon Q__

    _SnapDragon S4 Pro 1.5 GHz dual core, 1 GB RAM, 4.3' 960x540, 8 GB ROM espandibili microSD, prezzo variabile (va importato dagli USA)_

    ![Photon Q](http://cdn.androidcentral.com/sites/androidcentral.com/files/imagecache/w680h550/postimages/634222/motorola-photon-q-2.jpg)
...
1. __Samsung Galaxy Note II__

    _Exynos 4412 Quad (1.6 GHz quad core), 2 GB RAM, 4.3' 1280x720, 16/32/64 GB ROM espandibili microSD, ~400€_

    ![Galaxy Note 2](http://www.tuttoandroid.net/wp-content/uploads/2013/07/galaxy-note-21.jpg)

    + PRO: Pompatissimo e aggiornatissimo. Nessun tradeoff rispetto al Galaxy S3. In più avete il pennino che è di ottima qualità. Battery life molto buona. 
         
    + CONTRO: Non vi starà in tasca. Un Nexus 4 + un Nexus 7 insieme vi costano meno.
         
    + COMMENTO: È un ibrido ma è ottimo per certi usi tipo prendere appunti col pennino e per chi non deve preoccuparsi delle dimensioni del terminale (tipo professionisti che girano con la giacca, o chi ha borse etc). Valutate però il prezzo: un Nexus 4 accoppiato al Nexus 7 vi costa meno e avete DUE prodotti di qualità. Ne vale la pena?
